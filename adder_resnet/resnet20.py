...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10):
        ...
        self.conv1 = adder.adder2d(3, 16, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.fc = adder.adder2d(64 * block.expansion, num_classes, kernel_size=1, bias=False)
